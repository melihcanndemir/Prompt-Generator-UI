        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300 max-w-md">
                A professional tool for generating project prompts with
                customizable options for frameworks, libraries, and features.
                Perfect for developers starting new projects.
              </p>
            </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
            <p className="text-center text-sm text-gray-500 dark:text-gray-400">
              Professional Prompt Generator &copy; {new Date().getFullYear()} |
              Made with ❤️ by{" "}
              <a
                href="https://github.com/melihcanndemir"
                target="_blank"
